...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        ModeloDAO moddao = new ModeloDAO(FirebaseDatabase.getInstance().getReference());
        ComandoDAO cmddao = new ComandoDAO(FirebaseDatabase.getInstance().getReference());

        for (String k : marcas.keySet()) {
            mardao.syncCreate(marcas.get(k));

            for (Modelo m : marcas.get(k).getModelos()) {
                moddao.syncCreate(m);

                for (Comando c : m.getComandos()) {
                    cmddao.syncCreate(c);
                }
            }
        }
    ...
    private static void criarMarcas() {
        ...
        mod.getComandos().add(
                new Comando()
                        .setId("elgin:SRFI-12000-2:cool20")
                        .setNome("COOL 20°C")
                        .setRawData(Arrays.asList(
        ...
        mod.getComandos().add(
                new Comando()
                        .setId("elgin:SRFI-12000-2:cool21")
                        .setNome("COOL 21°C")
                        .setRawData(Arrays.asList(
        ...
        mod.getComandos().add(
                new Comando()
                        .setId("elgin:SRFI-12000-2:cool22")
                        .setNome("COOL 22°C")
                        .setRawData(Arrays.asList(
        ...
        mod.getComandos().add(
                new Comando()
                        .setId("elgin:SRFI-12000-2:cool23")
                        .setNome("COOL 23°C")
                        .setRawData(Arrays.asList(
        ...
        mod.getComandos().add(
                new Comando()
                        .setId("elgin:SRFI-12000-2:cool24")
                        .setNome("COOL 24°C")
                        .setRawData(Arrays.asList(
        ...
        mod.getComandos().add(
                new Comando()
                        .setId("elgin:SRFI-12000-2:cool25")
                        .setNome("COOL 25°C")
                        .setRawData(Arrays.asList(
    ...
    private static void criarEquipamentos() {
        Equipamento eq = new Equipamento()
                ...
                .setModelo(marcas.get("elgin").getModelos().get(0))
        ...
        eq = new Equipamento()
                .setId("tv_pr-cpr")
                .setModelo(marcas.get("lg").getModelos().get(0))
    ...
    private static void criarTransmissoes() {
        Transmissao tra = new Transmissao()
                .setComando(marcas.get("elgin").getModelos().get(0).getComandos().get(0))
        ...
        tra = new Transmissao()
                .setComando(marcas.get("elgin").getModelos().get(0).getComandos().get(6))
        ...
        tra = new Transmissao()
                .setComando(marcas.get("lg").getModelos().get(0).getComandos().get(0))
                .setDtHrSubmissao(new Date(new Date().getTime() - 60000))
                .setDtHrTransmissao(new Date(new Date().getTime() - 50000))
                .setUsuario(usuarios.get("fa89sd8f09s0df"))
    ...
    private static void relacionaEquipamentoGrupo() {
        grupos.get("a")
                .setEquipamentos(Arrays.asList(
                        equipamentos.get("ac_elgin_pr-cpr"),
                        equipamentos.get("tv_pr-cpr")
                ));
    }
