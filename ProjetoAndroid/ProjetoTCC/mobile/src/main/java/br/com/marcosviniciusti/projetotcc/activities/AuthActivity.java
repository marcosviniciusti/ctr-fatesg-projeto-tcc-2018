...
public class AuthActivity extends BaseActivity {
    ...
    private void bind() {
        ...
        try {
            ...
            // Inicializa objeto de negócios do login (passando o id do cliente web padrão e o contexto da aplicação).
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            if (resultCode == RESULT_OK) {
                bAuth.onActivityResult(requestCode, resultCode, data)
