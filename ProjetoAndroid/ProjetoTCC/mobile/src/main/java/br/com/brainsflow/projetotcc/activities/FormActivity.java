...
import br.com.brainsflow.projetotcc.persistence.DefinitionDao;
...
public class FormActivity extends AppCompatActivity {
    ...
    private void saveDefinition() {
        ...
        String arCondicionado = (String) spArcondicionado.getSelectedItem();
        String datashow = (String) spDatashow.getSelectedItem();
        String datashowOrientation = (String) spDatashowOrientation.getSelectedItem();
        String datashowResolution = (String) spDatashowResolution.getSelectedItem();
        String computer = (String) spComputer.getSelectedItem();
...
//        ((ListView) findViewById(R.id.lvDefinition)).setAdapter(adapter);// sets o adapter na listView

        //  Fecha a tela atual e volta a tela inicial do app
        Toast.makeText(getApplicationContext(), "Definição Salvada", Toast.LENGTH_SHORT).show();
    }
}